...
export default function BubbleMenu({
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent) => {
      ...
      // Close if click is not on the menu button or the menu items
      if (
        menuButton &&
        !menuButton.contains(target) &&
        !bubblesRef.current.some(bubble => bubble?.contains(target))
      ) {
        handleClose();
      }
    };
    ...
    <>
      ...
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        ...
        >
          ...
          <span
            className="menu-line block mx-auto rounded-[2px] transition-all duration-300 relative z-10"
            style={{
              width: 26,
              height: 2,
              background: '#000000',
          ...
          />
          <span
            className="menu-line short block mx-auto rounded-[2px] transition-all duration-300 relative z-10"
            style={{
              marginTop: '6px',
              width: 26,
              height: 2,
              ...
              >
                <a
                  ...
                  style={{
                      ...
                      ['--pill-bg']: isOnWhiteSection ? '#000000' : '#ffffff',
                      ['--pill-color']: isOnWhiteSection ? '#ffffff' : '#000000',
                      ['--hover-bg']: isOnWhiteSection ? '#ffffff' : '#000000',
                      ['--hover-color']: isOnWhiteSection ? '#000000' : '#ffffff',
